...
import { ManhwaBooksController } from './manhwa_books.controller';
import { ManhwaBooksService } from './manhwa_books.service';
import { ImagesModule } from 'src/images/images.module';

@Module({
    imports: [
        TypeOrmModule.forFeature([ManhwaBooks]),
        JwtModule.register({
    ...
    controllers: [ManhwaBooksController],
    providers: [ManhwaBooksService],
})
export class ManhwaBooksModule {}
